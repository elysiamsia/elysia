...
| `canonical` + JSON-LD | 9 页 `<head>` | 首页 `WebSite`，其余 `WebPage` + `BreadcrumbList` |
...
1. **建剩下 5 页英桀**（科斯魔 / 梅比乌斯 / 格蕾修 / 华 / 帕朵菲莉丝）—— 照 §4.1 的配方
...
| 维度 | 要求 |
|---|---|
| **配色** | 每位一套，**别撞**。现有：index 暖紫粉 / aponia 紫罗兰 / eden 金+酒红 / villv 品红紫 / kalpas 炭黑+橙红 / kevin 冷蓝 / su 青绿 / **sakura 冷靛+夜樱粉** |
| **专属特效** | `assets/site.js` 只抽了通用部分；画布粒子是**每页自己一套**（`#xxxCanvas`） |
| **专属互动模块** | su 木鱼 / kalpas 怒气条 / villv 抽卡 / aponia 命运之丝 / eden 黑胶唱片 / kevin 冰封的剑 / sakura 鞘中刀 |
...
| **`baseline-eggs`** | **三页彩蛋补齐之后**（2026-09-17） | **下次改动用这个** |
...
D:\claude-code\materials\<角色名>\                5 位待建英桀的建站材料包（台词/视觉/音频清单）
```
